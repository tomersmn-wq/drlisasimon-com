      ...
      <div className="space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-12">
          <div className="md:col-span-2 space-y-8">
            ...
            <p className="text-base md:text-lg text-foreground leading-relaxed">
              בנוסף, אני עוסקת בהעברת הרצאות והדרכות מקצועיות בעברית ובאנגלית, לאנשי מקצוע ולקהלים שונים, בנושאים הקשורים לבריאות הנפש, סטרס, טראומה ופסיכדלים.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-primary/50 p-6 rounded-lg">
              ...
              <ul className="space-y-3 text-base text-foreground" role="list">
                ...
                <li className="flex items-start gap-2">
                  <span aria-hidden="true">•</span>
                  <span>הסמכה לטיפול בMDMA ופסיכותרפיה ל PTSD (במחקרים קליניים בלבד)</span>
                </li>
              </ul>
            </div>
          </div>
