...
2. **[setup/EMAIL_SETUP.md](setup/EMAIL_SETUP.md)** - Email configuration
3. **[implementation/TECHNICAL_REFERENCE.md](implementation/TECHNICAL_REFERENCE.md)** - Technical deep dive
4. **[deployment/DEPLOYMENT_SUMMARY.md](deployment/DEPLOYMENT_SUMMARY.md)** - Deployment details
...
- See [implementation/TECHNICAL_REFERENCE.md](implementation/TECHNICAL_REFERENCE.md)
...
**By use case**:
- **Setup**: [setup/EMAIL_SETUP.md](setup/EMAIL_SETUP.md)
- **Quick ref**: [QUICK_REFERENCE.md](QUICK_REFERENCE.md)
- **Technical**: [implementation/TECHNICAL_REFERENCE.md](implementation/TECHNICAL_REFERENCE.md)
- **Deployment**: [deployment/DEPLOYMENT_SUMMARY.md](deployment/DEPLOYMENT_SUMMARY.md)
